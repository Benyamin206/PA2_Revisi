...
class AdminController extends Controller
{
    ...
    public function non_izin_kapal(){
        $kapals = Kapal::where('diizinkan', false)->get();
        return view('Kapal.approve', compact('kapals'));
    }

    public function approve_kapal(Kapal $kapal){
        $kapal->update([
            'diizinkan' => true
        ]);
        return redirect()->back()->with('success', 'Kapal berhasil diizinkan untuk ditambahkan.');
    }
