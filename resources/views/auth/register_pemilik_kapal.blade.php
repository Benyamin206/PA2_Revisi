...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Tambah Akun Pemilik Kapals</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('store_pemilik_kapal') }}">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="nomor_telepon" class="col-md-4 col-form-label text-md-end" >Nomor WhatsApp</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="alamat" class="form-control" name="alamat" value="{{old('alamat')}}" placeholder="isi alamat disini..." required></textarea>
                            </div>
                        </div>
