...
<body>
    <div class="d-flex align-items-center justify-content-center" style="background-color: blue; height: 50px;">
    ...
    <br><br><br><br><br><br><br><br>    <div class="container mt-6 mb-7">
          ...
          <div class="col-lg-12 col-xl-7">
            ...
            Keberangkatan : {{$order->jadwal->waktu_berangkat}}            <br>
                ...
                <table class="table border-bottom border-gray-200 mt-3">
                  ...
                  <tbody>
                    @foreach($order->detail_pesan_jadwal_pulang as $dpjp)
                    <tr>
                      <td class="px-0">{{$dpjp->muatan->nama}}</td>
                      <td class="px-0 ">{{'Rp ' . number_format($dpjp->muatan->harga_per_item, 2, ',', '.')}}</td>
                      <td class="px-1000">{{$dpjp->jumlah}}</td>
                      <td class="text-end px-0"><h6 style="color: blue">{{'Rp ' . number_format($dpjp->jumlah * $dpjp->muatan->harga_per_item, 2, ',', '.');}}</h6></td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>                 
              ...
              // Kirim request Ajax ke endpoint backend untuk validasi stok
                          ...
                          $('#pay-button').click(function(){
                            ...
                            onSuccess: function (result) {
                                ...
                                // window.location.href = 'jadwal/tiket/{{$order->id}}';
                                window.location.href = '{{ route("My_tiket", ["order_id" => $order->id]) }}';
                                console.log(result);
                            },
