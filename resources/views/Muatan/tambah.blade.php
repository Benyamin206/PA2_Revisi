            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('store_muatan') }}">
                        ...
                        <div class="row mb-3">
                            <label for="jenis_muatan" class="col-md-4 col-form-label text-md-end">Jenis Muatan</label>
                            <div class="col-md-6">
                                <select name="jenis_muatan_id" id="jenis_muatan" class="form-control">
                                    @foreach ($jenisMuatans as $jm)
