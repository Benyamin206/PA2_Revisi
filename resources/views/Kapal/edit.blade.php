            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('update_kapal', $kapal) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="tsb" class="col-md-4 col-form-label text-md-end">Tanggal tersedia booking :</label>
                            <div class="col-md-6">
                                <input id="tsb" type="date" name="tanggal_tersedia_booking" value="{{$kapal->tanggal_tersedia_booking}}" name="" id="">
                            </div>
                        </div>
